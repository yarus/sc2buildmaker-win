...
namespace SC2.UnitTests.TestData.LOTV
{
    public class ProtossBuildItemsDictionary
	{
		public static BuildItemsDictionary GenerateBuildItemsDictionary()
		{
            ...
            result.AddItem(ResonatingGlaves);

			result.AddItem(ExtendedThermalLance);
			result.AddItem(PsionicStorm);
            result.AddItem(AnionPulseCrystals);
            result.AddItem(ShadowStride);
		...
		private static BuildItemEntity DefaultItem
		{
			get
			{
				...
				defaultItem.OrderedActions.Add(new ChangeStatisticAction("Probe", 12));
        ...
        private static BuildItemEntity Adept
        {
            get
            {
                var item = new BuildItemEntity
        ...
        private static BuildItemEntity Disruptor
        {
            get
            {
                var item = new BuildItemEntity
		...
		private static BuildItemEntity Oracle
		{
			get
			{
				var item = new BuildItemEntity
		...
		private static BuildItemEntity Tempest
		{
			get
			{
				var item = new BuildItemEntity
		...
		private static BuildItemEntity MothershipCore
		{
			get
			{
				...
				item.OrderRequirements.Add(new StatLessThenValueRequirement("MothershipCore", 1));
				item.OrderRequirements.Add(new StatLessThenValueRequirement("MothershipCore" + Consts.BuildItemOnBuildingPostfix, 1));

				item.ProduceRequirements.Add(new StatLessThenValueRequirement("MothershipCore", 1));
				item.ProduceRequirements.Add(new StatLessThenValueRequirement("MothershipCore" + Consts.BuildItemOnBuildingPostfix, 1));
        ...
        private static BuildItemEntity WarpInAdept
        {
            get
            {
                var item = new BuildItemEntity
		...
		private static BuildItemEntity Nexus
		{
			get
			{
				...
				item.OrderedActions.Add(new ChangeStatisticAction(Consts.CoreStatistics.BuildingNewSupply, 15));
				item.OrderedActions.Add(new ChangeStatisticAction(Consts.CoreStatistics.GasGayser + Consts.BuildItemOnBuildingPostfix, 2));

				item.ProducedActions.Add(new ChangeStatisticAction(Consts.CoreStatistics.MaximumSupply, 15, "MaximumSupplyLimit"));
				item.ProducedActions.Add(new ChangeStatisticAction(Consts.CoreStatistics.BasesCount, 1));
				item.ProducedActions.Add(new ChangeStatisticAction(Consts.CoreStatistics.BuildingNewSupply, -15));
	    ...
	    private static BuildItemEntity ShieldBattery
	    {
	        get
	        {
	            var item = new BuildItemEntity
        ...
        private static BuildItemEntity ResonatingGlaves
        {
            get
            {
                var item = new BuildItemEntity
                {
                    Name = "ResonatingGlaves",
                    CostMinerals = 100,
                    CostGas = 100,
                    ItemType = BuildItemTypeEnum.Upgrade,
                    BuildTimeInSeconds = 100,
                    ProductionBuildingName = "TwilightCouncil",
                    DisplayName = "Resonating Glaves"
                };

                item.OrderRequirements.Add(new StatLessThenValueRequirement("ResonatingGlaves", 1));
                item.OrderRequirements.Add(new StatLessThenValueRequirement("ResonatingGlaves" + Consts.BuildItemOnBuildingPostfix, 1));

                item.ProduceRequirements.Add(new StatLessThenValueRequirement("ResonatingGlaves", 1));
                item.ProduceRequirements.Add(new StatLessThenValueRequirement("ResonatingGlaves" + Consts.BuildItemOnBuildingPostfix, 1));
        ...
        private static BuildItemEntity AnionPulseCrystals
        {
            get
            {
                var item = new BuildItemEntity
                {
                    ...
                    ProductionBuildingName = "FleetBeacon",
                    DisplayName = "Anion Pulse-Crystals"
                };

                item.OrderRequirements.Add(new StatLessThenValueRequirement("AnionPulseCrystals", 1));
                item.OrderRequirements.Add(new StatLessThenValueRequirement("AnionPulseCrystals" + Consts.BuildItemOnBuildingPostfix, 1));

                item.ProduceRequirements.Add(new StatLessThenValueRequirement("AnionPulseCrystals", 1));
                item.ProduceRequirements.Add(new StatLessThenValueRequirement("AnionPulseCrystals" + Consts.BuildItemOnBuildingPostfix, 1));

                return item;
            }
        }
        
        private static BuildItemEntity ShadowStride
        {
            get
            {
                var item = new BuildItemEntity
                ...
                item.OrderRequirements.Add(new StatLessThenValueRequirement("ShadowStride", 1));
                item.OrderRequirements.Add(new StatLessThenValueRequirement("ShadowStride" + Consts.BuildItemOnBuildingPostfix, 1));

                item.ProduceRequirements.Add(new StatLessThenValueRequirement("ShadowStride", 1));
                item.ProduceRequirements.Add(new StatLessThenValueRequirement("ShadowStride" + Consts.BuildItemOnBuildingPostfix, 1));
        ...
        private static BuildItemEntity MassRecall
	    {
	        get
	        {
	            var mule = new BuildItemEntity
	            {
	                ...
	                ItemType = BuildItemTypeEnum.Special,
	                DisplayName = "Mass Recall"
                };

	            mule.OrderRequirements.Add(new ItemExistsOrOnBuildingRequirement("Nexus"));
