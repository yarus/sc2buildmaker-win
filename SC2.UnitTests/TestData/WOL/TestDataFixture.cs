...
namespace SC2.UnitTests.TestData.WOL
{
    public static class TestDataFixture
	{
		...
		public static RaceSettingsEntity GetZergRaceSettings()
		{
			...
			settings.Modules = new BuildManagerModulesList { new ResourceModule(), new CastModule(), new LarvaModule(), new IdleModule() };
		...
		public static GlobalConstantsInfo GetGlobalConstants()
		{
			...
			consts.MineralsPerMinuteFrom3WorkersPerPatch = 102;
			consts.MineralsPerMinuteFrom2WorkersPerPatch = 83;
			consts.MineralsPerMinuteFrom1WorkerPerPatch = 42;
			consts.GasPerMinuteFrom3WorkersPerPatch = 115;
			consts.GasPerMinuteFrom2WorkersPerPatch = 87;
			consts.GasPerMinuteFrom1WorkerPerPatch = 44;
			consts.MineralsPerMinuteFrom1Mule = 180;
			return consts;
		}
