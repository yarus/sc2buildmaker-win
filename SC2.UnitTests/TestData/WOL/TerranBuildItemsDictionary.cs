...
namespace SC2.UnitTests.TestData.WOL
{
    public class TerranBuildItemsDictionary
    {
        public static BuildItemsDictionary GenerateBuildItemsDictionary()
        {
            ...
            result.AddItem(SiegeTech);
            result.AddItem(InfernalPreIgniter);

            result.AddItem(VehicleWeaponsLevel1);
            result.AddItem(VehiclePlatingLevel1);
            result.AddItem(VehicleWeaponsLevel2);
            result.AddItem(VehiclePlatingLevel2);

            result.AddItem(VehicleWeaponsLevel3);
            result.AddItem(VehiclePlatingLevel3);
            result.AddItem(ShipWeaponsLevel1);
            result.AddItem(ShipPlatingLevel1);
            
            result.AddItem(ShipWeaponsLevel2);
            result.AddItem(ShipPlatingLevel2);
            result.AddItem(ShipWeaponsLevel3);
            result.AddItem(ShipPlatingLevel3);

            result.AddItem(ThorStrikeCanons);
...
//        }
        ...
        private static BuildItemEntity NitroPacks
        {
            get
            {
                var item = new BuildItemEntity
                {
                    ...
                    DisplayName = "Nitro Packs"
                };

                item.OrderRequirements.Add(new StatLessThenValueRequirement("NitroPacks", 1));
                item.OrderRequirements.Add(new StatLessThenValueRequirement("NitroPacks" + Consts.BuildItemOnBuildingPostfix, 1));

                item.ProduceRequirements.Add(new StatLessThenValueRequirement("NitroPacks", 1));
                item.ProduceRequirements.Add(new StatLessThenValueRequirement("NitroPacks" + Consts.BuildItemOnBuildingPostfix, 1));
        ...
        private static BuildItemEntity SiegeTech
        {
            get
            {
                var item = new BuildItemEntity
                {
                    ...
                    DisplayName = "Siege Tech"
                };

                item.OrderRequirements.Add(new StatLessThenValueRequirement("SiegeTech", 1));
                item.OrderRequirements.Add(new StatLessThenValueRequirement("SiegeTech" + Consts.BuildItemOnBuildingPostfix, 1));

                item.ProduceRequirements.Add(new StatLessThenValueRequirement("SiegeTech", 1));
                item.ProduceRequirements.Add(new StatLessThenValueRequirement("SiegeTech" + Consts.BuildItemOnBuildingPostfix, 1));
        ...
        private static BuildItemEntity ThorStrikeCanons
        {
            get
            {
                var item = new BuildItemEntity
                {
                    Name = "ThorStrikeCanons",
                    DisplayName = "250mm Strike Canons",
                    CostMinerals = 150,
                    CostGas = 150,
                    ItemType = BuildItemTypeEnum.Upgrade,
                    BuildTimeInSeconds = 110,
                ...
                item.OrderRequirements.Add(new StatLessThenValueRequirement("ThorStrikeCanons", 1));
                item.OrderRequirements.Add(new StatLessThenValueRequirement("ThorStrikeCanons" + Consts.BuildItemOnBuildingPostfix, 1));

                item.ProduceRequirements.Add(new StatLessThenValueRequirement("ThorStrikeCanons", 1));
                item.ProduceRequirements.Add(new StatLessThenValueRequirement("ThorStrikeCanons" + Consts.BuildItemOnBuildingPostfix, 1));
